...
const loadDataIfUpdate = () => {
  if (
    stateStoreInstance.show &&
    stateStoreInstance.modalType === "update" &&
    stateStoreInstance.selectedClientId
  ) {
      ...
      <div class="modal-content p-15 p-md-40">
        <div class="modal-header d-block ps-0 pe-0 pt-0 pb-15 pb-md-25">
          <h5 class="modal-title fw-bold text-black">
            {{
              stateStoreInstance.modalType === "create"
        ...
        <div class="modal-body ps-0 pe-0 pb-0 pt-15 pt-md-25">
          <form>
            ...
            <button
              ...
              @click="addCliente(stateStoreInstance.selectedClientId || 0)"
            >
              GUARDAR
            </button>
          </form>
